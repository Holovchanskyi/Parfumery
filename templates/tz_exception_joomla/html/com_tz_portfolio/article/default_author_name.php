...
<?php if ($params->get('show_author', 1) && !empty($this->item->author)) : ?>
    ...
    <?php if ($params->get('link_author') == true): ?>
        ...
        ?>
        <?php echo JText::sprintf('TPL_EXEC_WRITTEN_BY_BLOG_ARTICLE', JHtml::_('link', JRoute::_($cntlink), $author, $target . ' itemprop="url"')); ?>
    <?php else: ?>
        <?php echo JText::sprintf('TPL_EXEC_WRITTEN_BY_BLOG_ARTICLE', $author); ?>
    <?php endif; ?>
</span>
<?php endif; ?>