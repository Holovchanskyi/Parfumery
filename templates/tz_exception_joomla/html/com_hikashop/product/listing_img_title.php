...
<!-- PRODUCT NAME -->
<h3 class="hikashop_product_name item-title">
...
<!-- PRODUCT IMG -->
<div style="height:<?php echo $this->image->main_thumbnail_y; ?>px;text-align:center;clear:both;"
     class="hikashop_product_image item-img">
    <div
