...
<?php if ($this->listsArticle): ?>
    ...
    <?php foreach ($this->listsArticle as $i => $row): ?>
        ...
        ?>
        <div class="cell-3 item <?php echo $class; ?>"
        ...
        <div class="portfolio-item tz-content">
                ...
                <?php if ((isset($listMedia[0]->type) AND $listMedia[0]->type != 'quote'
                    ...
                    <?php if ($params->get('show_image', 1) == 1 OR $params->get('show_image_gallery', 1) == 1
                    ...
                    <div class="name-holder">
                        ...
                        <?php if ($params->get('show_author') && !empty($row->author)) : ?>
                            <div class="TzPortfolioCreatedby" itemprop="author" itemscope
                        ...
                        <?php if ($params->get('show_hits')) : ?>
                            <div class="TzPortfolioHits">
                                ...
                                <meta itemprop="interactionCount"
                                      content="UserPageVisits:<?php echo $row->hits; ?>"/>
                            </div>
                        <?php endif; ?>
                        <?php if ($params->get('tz_show_count_comment', 1) == 1): ?>
                            <div class="TzPortfolioCommentCount" itemprop="comment" itemscope
                                ...
                                <?php if ($params->get('tz_comment_type') == 'jcomment'): ?>
                                    ...
                                    if (file_exists($comments)) {
                                        ...
                                        if (class_exists('JComments')) {
                                            ...
                                            <span
                                                itemprop="commentCount"><?php echo JComments::getCommentsCount((int)$row->id, 'com_tz_portfolio'); ?></span>
                                        <?php
                                        }
                                    }
                                    ?>
