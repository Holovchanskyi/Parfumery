...
if (!$this->identified) {
    ...
    if ($this->display_method == 0) {
        ...
        if ($display_login) {
            if ($this->registration[2]) {
                echo '<h3 class="widget-head">' . JText::_('LOGIN_OR_GUEST') . '</h3>';
            } else {
                echo '<h3 class="widget-head">' . JText::_('LOGIN_OR_REGISTER_ACCOUNT') . '</h3>';
            }
        }
        ?>
        <div id="hikashop_checkout_login" class="hikashop_checkout_login row-fluid margin-top--20">
            <?php
            if ($display_login) {
                ?>
                <div id="hikashop_checkout_login_left_part" class="hikashop_checkout_login_left_part span4 input">
                    <div class="login_hika">
                        <h3 class="widget-head" ><?php echo JText::_('HIKA_LOGIN'); ?></h3>
                        <?php echo $this->loadTemplate('form'); ?>
                    </div>
                </div>
            <?php } ?>
            <div id="hikashop_checkout_login_right_part" class="hikashop_checkout_login_right_part span8 input">
                <div class="regis_hika contact-form">
    ...
    <?php
        ...
        <div id="hikashop_checkout_login" class="hikashop_checkout_login row-fluid">
            ...
            <?php } ?>
            <div id="hikashop_checkout_login_right_part"
                 class="hikashop_checkout_login_right_part <?php echo $span; ?>">
