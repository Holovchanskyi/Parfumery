...
class JFormFieldTzTab extends JFormFieldList
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION, '3.0', 'ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_tab/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_tab/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_tab/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_tab/admin/formfields/js/jquery-ui-min.js');
        $script = array();
        $script[] = '
...
//                                                                            e.setProperty("value","gfgf");
                            ...
                            del = new Element("button",{
                                ...
                                events:{
                                    "click": function(){
                                        var message = confirm("' . JText::_('MOD_TZ_IMAGE_BANNER_DELETE_QUESTION') . '");
                                        if(message){
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_IMAGE_BANNER_INFORMATION_LABEL') . '</th>';
        }
