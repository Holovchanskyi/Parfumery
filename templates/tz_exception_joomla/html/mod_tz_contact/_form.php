...
<?php if ($params->get('show_email_form', 1)): ?>
    ...
    <form class="form-signin cform" method="post"
        ...
        <div class="form-input">
            ...
            <div id="name_error_label" class="arrow_box"></div>
        </div>
        <div class="form-input">
            ...
            <div id="email_error_label" class="arrow_box"></div>
        ...
        <?php if ($params->get('show_subject', 1)): ?>
            <div class="form-input">
                ...
                <label
                    ...
                    <div id="subject_error_label" class="arrow_box"></div>
        ...
        <div class="form-input">
            ...
            <div id="mess_error_label" class="arrow_box"></div>
