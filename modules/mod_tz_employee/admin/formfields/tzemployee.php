...
class JFormFieldTzEmployee extends JFormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION,'3.0','ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_employee/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_employee/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_employee/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_employee/admin/formfields/js/jquery-ui-min.js');
        $script = array();
...
//        });';
        ...
        $script[] = '        if(obj.get("tag") == "textarea"){console.log(obj.getProperty("value"));};';
        ...
        $script[] = '
           console.log(obj.get("tag"));
           console.log(obj.getProperty("value"));
            console.log(form.getElements("input,select,textarea"));
...
//        $script[] = '    }).inject(tr);';
        ...
        $script[] = ' var td1 = new Element("td",{class: "index"}).inject(tr);';
        ...
        $script[] = '                                     }
                         ...
                         del = new Element("button",{
                           ...
                           events:{
                             "click": function(){
                               var message = confirm("' . JText::_('MOD_TZ_EMPLOYEE_DELETE_QUESTION') . '");
                                 if(message){
...
//        $html[] = '     <div id="drag">';
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_EMPLOYEE_INFORMATION') . '</th>';
        }
