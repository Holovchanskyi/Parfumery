...
if ((!empty($this->rows) || !$this->module || JRequest::getVar('hikashop_front_end_main', 0)) && $this->pageInfo->elements->total) {
    ...
    <?php }  ?>
    <div class="hikashop_products" style="margin-top: 50px;">
        <?php
            ...
            if ($enableCarousel) {
                ...
                foreach ($this->rows as $row) {
                    if (!HIKASHOP_RESPONSIVE) {
                        ...
                        <div class="hikashop_container fx shop-item" data-animate="fadeInUp">
                        <div class="hikashop_subcontainer <?php echo $this->borderClass; ?> item-box">
                    <?php
                    } else {
                        ?>
                        <li class="cell-<?php echo $span; ?> hikashop_product hikashop_product_column_<?php echo $current_column; ?> hikashop_product_row_<?php echo $current_row; ?>">
                        <div class="hikashop_container fx shop-item"  data-animate="fadeInUp">
                        <div class="hikashop_subcontainer <?php echo $this->borderClass; ?> item-box">
                    <?php
                    }
                    ...
                    $this->row =& $row;
//                    var_dump($this->params->get('div_item_layout_type')); die;
