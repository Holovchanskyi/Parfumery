        ...
        <?php else: ?>
            <?php if ($params->get('tz_comment_type') == 'facebook'): ?>
                <?php if (isset($this->item->commentCount)): ?>
                    <?php echo JText::sprintf('TPL_EXEC_BLOG_COMMENT_COUNT', $this->item->commentCount); ?>
                <?php endif; ?>
            <?php endif; ?>
            <?php if ($params->get('tz_comment_type') == 'disqus'): ?>
                <?php if (isset($this->item->commentCount)): ?>
        ...
        <?php if ($params->get('tz_comment_type') == 'jcomment'): ?>
            ...
            if (file_exists($comments)) {
                ...
                if (class_exists('JComments')) {
                    ?>
                    <?php echo JText::sprintf('TPL_EXEC_BLOG_COMMENT_COUNT', JComments::getCommentsCount((int)$this->item->id, 'com_tz_portfolio')); ?>
                <?php
                }
            }
            ?>
