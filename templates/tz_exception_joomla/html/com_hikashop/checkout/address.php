...
if ($this->identified) {
    ...
    <div id="<?php echo $mainId; ?>" class="<?php echo $mainClass; ?>">
        ...
        <div id="hikashop_checkout_address_right_part"
             class="hikashop_checkout_address_right_part<?php if (HIKASHOP_RESPONSIVE) {
                 echo ' span6';
             } ?>">
                ...
                <?php
                    ...
                    if ($config->get('shipping_address_same_checkbox', 1)) {
                        ...
                        <label for="same_address">
                            <input class="hikashop_checkout_shipping_same_address inputbox"
                                   <?php echo $checked; ?>type="checkbox" id="same_address" name="same_address"
                                   value="yes" alt="Same address" onclick="<?php echo $onclick; ?>"/>
                    ...
                    ?>
                    <div class="hikashop_checkout_shipping_div"
                         id="hikashop_checkout_shipping_div" <?php echo $style; ?>>
                        <?php
