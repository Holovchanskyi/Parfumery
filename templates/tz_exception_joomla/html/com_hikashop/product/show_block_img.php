...
?>
<div id="hikashop_product_image<?php echo $variant_main; ?>" class="hikashop_global_image_div product-img"
     style="<?php echo $display_mode; ?>">
    <div id="hikashop_main_image_div<?php echo $variant_name; ?>" class="hikashop_main_image_div">
        ...
        if (!$this->config->get('thumbnail')) {
            ...
            <div class="hikashop_product_main_image_thumb"
                 id="hikashop_image_main_thumb_div<?php echo $variant_name; ?>" <?php echo $style; ?> >
                <div style="<?php if (!empty($divHeight)) {
                    echo 'height:' . ($divHeight + 20) . 'px;';
                } ?>text-align:center;clear:both;" class="hikashop_product_main_image">
                    <div style="position:relative;text-align:center;clear:both;<?php if (!empty($divWidth)) {
                        echo 'width:' . $divWidth . 'px;';
                    } ?>margin: auto;" class="hikashop_product_main_image_subdiv">
                        <?php
    ...
    <div class="thumbs">
        <ul id="hikashop_small_image_div<?php echo $variant_name; ?>" class="hikashop_small_image_div">
