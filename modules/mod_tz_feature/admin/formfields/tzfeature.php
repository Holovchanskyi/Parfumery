...
class JFormFieldTzFeature extends JFormFieldList
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION, '3.0', 'ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_feature/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_feature/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_feature/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_feature/admin/formfields/js/jquery-ui-min.js');
        $script = array();
        $script[] = '
                                        ...
                                        "click": function(){
                                            ...
                                            if(eObj.getElement("input")){
                                                $$("input[name=\"' . $element['name'] . '_task\"]").setProperty("value",this.value);
                                                 console.log(eObj.getElement("input").value);
...
//                                                                            e.setProperty("value","gfgf");
                            ...
                            del = new Element("button",{
                                ...
                                events:{
                                    "click": function(){
                                        var message = confirm("' . JText::_('MOD_TZ_FEATURE_DELETE_QUESTION') . '");
                                        if(message){
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_FEATURE_INFORMATION_LABEL') . '</th>';
        }
