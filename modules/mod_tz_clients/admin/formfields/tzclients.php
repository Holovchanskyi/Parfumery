...
class JFormFieldTzClients extends JFormFieldList
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION, '3.0', 'ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_clients/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_clients/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_clients/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_clients/admin/formfields/js/jquery-ui-min.js');
        $script = array();
        $script[] = '
...
//                                                                            e.setProperty("value","gfgf");
                            ...
                            del = new Element("button",{
                                ...
                                events:{
                                    "click": function(){
                                        var message = confirm("' . JText::_('MOD_TZ_IMAGE_HOVER_DELETE_QUESTION') . '");
                                        if(message){
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_IMAGE_HOVER_INFORMATION_LABEL') . '</th>';
        }
