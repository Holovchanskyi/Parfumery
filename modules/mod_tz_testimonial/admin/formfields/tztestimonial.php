...
class JFormFieldTzTestimonial extends JFormField
{
	/**
	 * The form field type.
	 *
    ...
    protected function getInput()
    {
        ...
        $doc -> addScript(JUri::root(true).'/modules/mod_tz_testimonial/admin/js/base64.js');
        $script     = array();
        ...
        if(!$childRequired){
            $html[] = '               <th>'.JText::_('MOD_TZ_TESTIMONIAL_INFORMATION').'</th>';
        }
