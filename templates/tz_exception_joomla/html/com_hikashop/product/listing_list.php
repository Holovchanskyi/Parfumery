                ...
                <ul class="hikashop_product_list<?php echo $this->params->get('ul_class_name'); ?>">
                    <?php foreach ($this->rows as $row) {
                        ...
                        <li class="hikashop_product_list_item" <?php echo $width; ?>>
                            <?php $img = $this->image->getThumbnail(@$this->row->file_path, array('width' => $this->image->main_thumbnail_x, 'height' => $this->image->main_thumbnail_y));
                            if ($img->success) {
                                echo '<div class="post-img"><img class="hikashop_product_listing_image" title="' . $this->escape(@$this->row->file_description) . '" alt="' . $this->escape(@$this->row->file_name) . '" src="' . $img->url . '"/></div>';
                            }
                            ?>
                            ...
                            if ($this->params->get('show_vote_product')) {
                                ...
                                <div class="meta">
                                    <div class="item-rating">
                                        <?php $this->setLayout('listing_vote');
                                        echo $this->loadTemplate();?>
                                    </div>
                                </div>
                            <?php
