    ...
    <table cellpadding="0" cellspacing="0" border="0" class="hikashop_contentpane">
            ...
            <tr class="hikashop_registration_name_line" id="hikashop_registration_name_line">
                ...
                <td>
                    <input type="text" name="data[register][name]" id="register_name"
                           value="<?php echo $this->escape($this->mainUser->get('name')); ?>" class="inputbox required"
                           maxlength="50"/> *
                </td>
            </tr>
        ...
        <tr class="hikashop_registration_email_line">
            ...
            <td>
                <input type="text" id="register_email" name="data[register][email]"
                       value="<?php echo $this->escape($this->mainUser->get('email')); ?>"
        ...
        <?php if ($this->config->get('show_email_confirmation_field', 0)) { ?>
            <tr class="hikashop_registration_email_confirm_line">
                ...
                <td>
                    <input type="text" id="register_email_confirm" name="data[register][email_confirm]"
                           value="<?php echo $this->escape($this->mainUser->get('email')); ?>"
                           class="inputbox required validate-email" maxlength="100"
        ...
        if (!$this->simplified_registration || $this->simplified_registration == 3) {
            ...
            <tr class="hikashop_registration_password_line" id="hikashop_registration_password_line">
                ...
                <td>
                    <input class="inputbox required validate-password" type="password" id="register_password"
            ...
            <tr class="hikashop_registration_password2_line" id="hikashop_registration_password2_line">
                ...
                <td>
                    <input class="inputbox required validate-passverify" type="password" id="register_password2"
                    ...
                    <label for="hikashop_affiliate_checkbox">
                        ...
                        if (!empty($affiliate_terms)) {
                            ...
                            <a class="hikashop_affiliate_terms_link" id="hikashop_affiliate_terms_link" target="_blank"
                               href="<?php echo JRoute::_('index.php?option=com_content&view=article&id=' . $affiliate_terms); ?>"><?php echo $label; ?></a>
                            </span><?php
                        } else {
                            echo $label;
                        } ?>
