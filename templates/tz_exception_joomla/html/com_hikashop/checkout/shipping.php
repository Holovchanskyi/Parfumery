            ...
            <table class="hikashop_shipping_methods_table table table-striped table-hover">
                ...
                foreach ($this->rates as $rate) {
                    ...
                    <tr class="row<?php echo $k; ?>">
                        ...
                        <td>
                            <input class="hikashop_checkout_shipping_radio" type="radio"
                                   name="hikashop_shipping<?php echo $shipping_key; ?>"
                                   id="hikashop_shipping_<?php echo $rate->shipping_type . '_' . $rate->shipping_id . $shipping_key; ?>"
                                   value="<?php echo $rate->shipping_type . '_' . $rate->shipping_id . $shipping_key; ?>" <?php echo $checked; ?> />
                        </td>
                        <td><label
                                for="hikashop_shipping_<?php echo $rate->shipping_type . '_' . $rate->shipping_id . $shipping_key; ?>"
...
<?php } else { ?>
                    <td>
                        ...
                        <label class="btn btn-radio"
                               for="hikashop_shipping_<?php echo $rate->shipping_type . '_' . $rate->shipping_id . $shipping_key; ?>"><?php echo $rate->shipping_name; ?></label>
...
?>
                        ...
                        <td><label
                            ...
                            <?php } ?>
                            <div
                                class="hikashop_checkout_shipping_description"><?php echo $rate->shipping_description; ?></div>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <input type="radio" style="display:none;"
                                   name="hikashop_shipping_<?php echo $shipping_group_key; ?>"
                                   value="-_<?php echo $shipping_group_key; ?>" checked="checked"/>
                        </td>
                    </tr>
                <?php
                }
