...
if ($list):?>
    <div style="background-image: url(<?php echo $params->get('background_parallax') ?>);"
         class="oe-full-banner dark-overlay oe-fixed-banner" data-stellar-background-ratio="0.1">

        <div class="container">
            <div class="row">
                <div class="col-md-12 oe-reflect padding">
