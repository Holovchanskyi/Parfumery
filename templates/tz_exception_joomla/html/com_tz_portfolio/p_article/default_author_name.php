...
<?php if ($params->get('show_author', 1) && !empty($this->item->author)) : ?>
    <li itemprop="author" itemscope itemtype="http://schema.org/Person">
        <i class="<?php echo JText::_('ICON_AUTHOR_PORTFOLIO_SINGLE')?>"></i>
        <span class="main-color"><?php echo JText::_('AUTHOR_PORTFOLIO_SINGLE')?></span>
        ...
        <?php if ($params->get('link_author') == true): ?>
            ...
            ?>
            <?php echo JHtml::_('link', JRoute::_($cntlink), $author, $target . ' itemprop="url"'); ?>
        <?php else: ?>
            <?php echo  $author; ?>
        <?php endif; ?>
